...
class SmartWatchListScreen extends StatefulWidget {
  final String categoryName;
  final List<String> selectedBrands;
  final RangeValues selectedPriceRange;
  final AppUser user;

  const SmartWatchListScreen({
    super.key,
  ...
  @override
  _SmartWatchListScreenState createState() => _SmartWatchListScreenState();
}

class _SmartWatchListScreenState extends State<SmartWatchListScreen> {
  final ProductService _productService = ProductService();
  final String _smartWatchCategoryId = '37kU0v41ZFICXKMnw4EA';
            ...
            return ListView(
              ...
              children: [
                ...
                GridView.builder(
                  shrinkWrap: true,
                  physics:
                      const NeverScrollableScrollPhysics(), // GridView ko bị cuộn riêng
